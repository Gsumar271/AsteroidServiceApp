...
public class AsteroidListWidget extends AppWidgetProvider {
	...
	public void onUpdate(Context context,
	   ...
	   for (int i = 0; i < N; i++){
		   ...
		   Intent intent = new Intent(context, AsteroidRemoteViewsService.class);
	   	   // Add the app widget ID to the intent extras.
		   intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId);

		   // Instantiate the RemoteViews object for the App Widget layout.
		   RemoteViews views = new RemoteViews(context.getPackageName(),
		        R.layout.asteroid_collection_widget);
		   ...
		   Intent templateIntent = new Intent(context, Asteroid.class);
